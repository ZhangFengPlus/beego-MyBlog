...
func (c *AdminController) Config() {
	...
	//options 数组内 结构
	//map[keywords:dsfds description:fdsfdsfdsfdsfdsfds email:lisijie86@gmail.com timezone:8 start:1 qq:1212121 title:fdsfdsfdsfdsfds url:http://www.ptapp.cnsdfdsfds]


	//mp 数组结构
	//map[qq:0xc0001c3290 title:0xc0001c2810 url:0xc0001c2870 keywords:0xc0001c2f30 description:0xc0001c2ff0 email:0xc0001c3050 timezone:0xc0001c30b0 start:0xc0001c3140]
...
func (c *AdminController) Login() {
	if c.Ctx.Request.Method == "POST" {
		...
		//但是,如果查询到数据库中有username的值，则把其整体赋值给user
